...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Descripcion: Write a short summary, because Rubygems requires one.}
  spec.description   = %q{Descripcion de prueb: Write a longer description or delete this line.}
  spec.homepage      = "http://monkeykoders.com"
  spec.license       = "MIT"
